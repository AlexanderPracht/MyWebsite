...
label=paste("Flights Lufthansa Cargo October"),color="white")+
  labs(title = "Fewer flight are planned for October at Lufthansa Cargo", y="Latitude", x="Longitude")
```
...
label=paste("Flights Lufthansa Cargo November"),color="white")+
  labs(title = "More routes are planned for November at Lufthansa Cargo", y="Latitude", x="Longitude")
