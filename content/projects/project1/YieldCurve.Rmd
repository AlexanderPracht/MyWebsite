...
- ""
date: "r Sys.Date()"
description: What the yield curve shows...
draft: false
image: money.jpg
keywords: ""
slug: YieldCurve
...
# What Yiel Curves Can Predict...

Yield curves of US treasuries show the different yields for different maturity dates. 
We looked at US data and used the [FRED database](https://fred.stlouisfed.org/). Although we have the yields for maturities between 3 months and 30 years, we would like to focus on only two of them:
...
The following plot shows the spread between 30 years and 3 months as a blue/red ribbon, based on whether the spread is positive (blue) or negative(red).
Furthermore it includes US recessions (grey shaded areas).
...
Furthermore, since 1999 the 3-month Bill yield more than a 10-year-rate in the following years: 2000 and 2006-2007
