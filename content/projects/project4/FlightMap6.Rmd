...
label=paste("Flights Lufthansa Cargo October"),color="white")+
  labs(title = "Fewer flight are planned for October at Lufthansa Cargo", colour = "Number of flights per route", y="", x="")
```

## Lufthansa Cargo Flight Schedule (November 2020)

```{r, plottingNov, fig.width=15}
# November
ggplot() +
wrld +
urb+
...
label=paste("Flights Lufthansa Cargo November"),color="white")+
  labs(title = "More routes are planned for November at Lufthansa Cargo", colour = "Number of flights per route", y="", x="")
